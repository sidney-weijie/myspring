...
public abstract class AbstractWebUtils {
	...
	public static String doPost(String url, Map<String, String> params, String charset, int connectTimeout,
		...
		return doPostWithHeader(url, ctype, content, connectTimeout, readTimeout, headerMap);
	}
	...
	public static String doPost(String url, String ctype, byte[] content, int connectTimeout, int readTimeout)
			throws IOException {
		return doPostWithHeader(url, ctype, content, connectTimeout, readTimeout, null);
	}

	private static String doPostWithHeader(String url, String ctype, byte[] content, int connectTimeout, int readTimeout,
	...
	public static void main(String[] args) throws IOException {
		...
		String x = doPost("http://localhost:8080/iboxpay-ktbao/login?systemName=xxuu&systemPW=E10ADC3949BA59ABBE56E057F20F883E", new HashMap<String,String>(), "", 100000, 100000);
